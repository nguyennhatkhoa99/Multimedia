...
def config_dataset(config):
    ...
    # config["data_path"] = "./dataset/" + config["dataset"] + "/train/"
...
def cifar_dataset(config):
    ...
    cifar_dataset_root = '/content/drive/MyDrive/Hashing/data/cifar10/'
    # Dataset
...
def get_data(config):
    ...
    for data_set in ["train_set", "test", "database"]:
        dsets[data_set] = ImageList(config["data_path"],
                                    ...
                                    transform=image_transform(config["resize_size"], config["crop_size"], "database"))
...
def get_database(config):
    ...
    data_config = config["data"]
    print(config["data_path"])
    dsets["database"] = ImageList(config["data_path"],
    ...
    dset_loaders["database"] = util_data.DataLoader(dsets["database"],
                                                    ...
                                                    generator=g,
                                                    shuffle=False, num_workers=4)
    return  dset_loaders["database"], len(dsets["database"])
